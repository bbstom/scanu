...
export default function EthereumApiPage() {
  ...
  const loadConfig = async () => {
    try {
      ...
      if (res.ok) {
        ...
        const apiConfig = data.settings.find((s: any) => s.key === "API_CONFIG_ETH");
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl font-bold mb-2">以太坊 (ETH) API 配置</h1>
            <p className="text-gray-600 dark:text-gray-400">
              配置以太坊区块链的 API 平台，系统会按优先级顺序调用
            </p>
          </div>
