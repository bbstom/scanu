...
export default function TronApiPage() {
  ...
  const defaultPlatforms: ApiPlatform[] = [
    { name: "TronGrid", url: "https://api.trongrid.io", apiKey: "", enabled: true, priority: 1 },
    { name: "TronScan", url: "https://apilist.tronscan.org/api", apiKey: "", enabled: true, priority: 2 },
  ];
  ...
  const loadConfig = async () => {
    try {
      ...
      if (res.ok) {
        ...
        const apiConfig = data.settings.find((s: any) => s.key === "API_CONFIG_TRX");
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 p-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl font-bold mb-2">波场 (TRX) API 配置</h1>
            <p className="text-gray-600 dark:text-gray-400">
              配置波场区块链的 API 平台，系统会按优先级顺序调用
            </p>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
            ...
            <ul className="text-sm text-blue-800 dark:text-blue-300 space-y-1">
              ...
              <li>• API Key 为空时，将使用免费公共 API</li>
              <li>• 建议至少保留 2 个备用平台</li>
            </ul>
          </div>
